...
// $sql="UPDATE users set picture='$image' where email='$sess'";
// $qr=mysqli_query($conn,$sql);
// if(move_uploaded_file($destination,$target)){
//     echo "picture Uploaded Successfully";
// }else{
    ...
    <body>
        ...
        <div class="main">
            ...
            <div class="form-container">
                    <form action="profupdatestu.php" name="myForm" method="POST"  enctype="multipart/form-data">
                     <input type="file" name="image" id="image"><br>
                    <input type="submit" name="upload" value="Upload Image">                        
                    </form>
            </div>
        </div>
        <a href="profilestu.php">Back to Profile</a>
