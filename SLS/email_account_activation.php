...
try {
  ...
  //---------------------Recipients-------------------------
  // $mail->setFrom('larrytherealest@gmail.com', 'Student Leave System');
  // $mail->addAddress('larrytherealest@gmail.com','Student');

  $mail->setFrom('laurencekisanga@atchosting.ac.tz', 'Student Leave System');
  $mail->addAddress($em,'Student');
  ...
  $mail->Body    = "  
    ...
    <div style='text-align:center; margin-top:50px;'> 
     <h2>click the link to activate your account:</h2> <h1 style='color:red;'><u>http://atchosting.ac.tz/SLS/verify.php?key=$vkey</u></h1></div>
     ";
